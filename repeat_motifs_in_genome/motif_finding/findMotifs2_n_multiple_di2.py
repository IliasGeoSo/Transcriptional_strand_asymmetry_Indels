...
# 32 jobs as of now ( 1 motifs per job)
...
for filed in files:
	...
	output_dir_path = "/nfs/compgen-04/team218/ilias/indels_pancan_motif_analysis_strand_bias_polyN2/general/patient_outputs_pancan_opposite_1/All_chr_hg19_di"
